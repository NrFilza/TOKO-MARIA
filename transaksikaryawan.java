...
public class transaksikaryawan extends javax.swing.JFrame {
...
public void konversiRupiah(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(transaksikaryawan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new transaksikaryawan().setVisible(true);
            }
        });
    }
